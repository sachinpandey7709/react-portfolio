...
const educationItems = [
  {
    ...
    bullets: [
      ...
      "Focused on Artificial Intelligence, IOT, and Cybersecurity.",
      "Actively working in the field of Cybersecurity and Ethical Hacking.",
    ],
  },
  {
    ...
    bullets: [
      "Diploma in Civil Engineering: 80%.",
