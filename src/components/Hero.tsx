      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Cybersecurity Expert &amp; Web Developer | Civil Engineer
            </motion.p>
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              I build secure, data-driven solutions with a strong focus on
              cybersecurity. Passionate about protecting systems, detecting
              threats, and transforming secure data with modern technologies.
            </motion.p>
            ...
            >
              <motion.a
                href="https://github.com/sachinpandey7709"
                target="_blank"
                rel="noopener noreferrer"
                className="
                  text-slate-700 dark:text-slate-400
              ...
              <motion.a
                href="https://www.linkedin.com/in/sachin-kumar-pandey-b918092b7"
                target="_blank"
                rel="noopener noreferrer"
                className="
                  text-slate-700 dark:text-slate-400
              ...
              <motion.a
                href="mailto:sachinkumarpandey1028@gmail.com"
                className="
                  text-slate-700 dark:text-slate-400
                  hover:text-cyan-600 dark:hover:text-cyan-400
                  transition-colors duration-150
